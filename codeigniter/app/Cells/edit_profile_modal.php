    ...
    <div class="modal-content bg-dominant rounded-5 border-0">
      <div class="modal-body p-0">
        <div class="d-flex justify-content-between align-items-center p-4">
          ...
          <button class="circle-button circle-button-sm text-white bg-transparent"
        ...
        <div class="p-3">
          <div class="mb-4">
            ...
            <div class="form-input-container">
              <input type="text" class="form-input" id="name" placeholder="Nombres" autocomplete="off" x-model="name">
            </div>
          </div>
          <div class="mb-4">
            <label class="fw-bold mb-2" for="last">Apellidos</label>
            <div class="form-input-container">
              <input type="text" class="form-input" id="last" placeholder="Apellidos" autocomplete="off" x-model="last">
            </div>
          </div>
          <div class="mb-4">
            <label class="fw-bold mb-2" for="password">Contraseña</label>
            <div class="form-input-container">
              <input type="password" class="form-input" id="password" placeholder="Contraseña" autocomplete="off" x-model="password">
            </div>
          </div>
          <div class="mb-4">
            <label class="fw-bold mb-2" for="confirmPassword">Confirmar contraseña</label>
            <div class="form-input-container">
              <input type="password" class="form-input" id="confirmPassword" placeholder="Confirmar contraseña" autocomplete="off" x-model="confirmPassword">
            </div>
          </div>
          <div 
            class="text-center"
