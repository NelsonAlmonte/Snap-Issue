...
<br />
<div align="center">
  <a href="https://github.com/NelsonAlmonte/Snap-Issue"></a>

  <h2 align="center">Snap Issue</h2>
...
Snap Issue is an app that citizens can use to report issues in their communities with the use of their cell phone and camera.

Snap Issue is a web app disguised as a mobile app that I quickly needed to make for a final project in my university.

## Features

* Use your camera to report an issue.
* A map to show nearby issues reported by other citizens.
...
Snap Issue uses [MySQL](https://www.mysql.com/) as the database, so you need to have a database created named `snap`.
...
1. Clone the repo.
   ```sh
   git clone https://github.com/NelsonAlmonte/Snap-Issue.git
   ```
...
4. Using a terminal navigate to the `codeigniter` directory and run the following command (You need to have the `snap` database already created for this to work):
   ```sh
    php spark migrate
   ```
...
Project Link: [https://github.com/NelsonAlmonte/Snap-Issue](https://github.com/NelsonAlmonte/Snap-Issue)
